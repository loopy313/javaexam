...
b. int[] arr = {1,2,3,};
c. int[] arr = new int[5];
d. int[] arr = new int[5]{1,2,3,4,5};//중괄호 안에 나열된 값의 개수에 의해 길이가 자동으로 결정됨으로 대괄호안의 길이는 안적어도 된다. 
e. int arr[5];=int arr[]=new int[5]; 으로 초기화 해야 한다.
f. int[] arr[] = new int[3][];//2차원배열의 주소만 일단 생성된 경우
...
int cnt=0;
	...
	average=Math.round((float)total/cnt*100)/100f;
